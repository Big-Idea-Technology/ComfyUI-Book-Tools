...
- add_text_overlay: Adds text to an image according to specified parameters such as horizontal alignment (left/right/center), vertical alignment (top/middle/bottom), color, font size, etc.
